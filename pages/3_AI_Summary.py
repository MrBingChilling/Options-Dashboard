...
st.markdown(
    """
    <style>
      .block-container {padding-top:.9rem; padding-bottom:3rem; max-width:1050px;}
      .summary-meta {
...
report_by_date: dict[date, DailySummary] = {report.snapshot_date: report for report in reports}
